...
(function (root, factory) {
  ...
  class ControlBusEngine {
    constructor() {
      ...
      // 3. WebSocket is optional. GitHub Pages is HTTPS/static, so an insecure
      //    ws:// connection to port 5050 would be blocked by the browser.
      //    Same-browser demo sync is handled by BroadcastChannel + localStorage.
